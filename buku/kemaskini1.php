...
<td width="350px"><input type="text" name="supplier_id" size="20" value="<?php echo $row1['supplier_id'];?>"></td>
</tr>
<tr>
<td width="150px">Supplier Name</td>
<td width="350px"><input type="text" name="supplier_name" size="40" value="<?php echo $row1['supplier_name'];?>"></td>
</tr>
<tr>
<td width="150px">Email</td>
<td width="350px"><input type="text" name="email" size="40" value="<?php echo $row1['email'];?>"></td>
</tr>
<tr>
<td colspan="2">&nbsp;</td>
</tr>
